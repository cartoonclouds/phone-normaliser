...
function isEmpty(raw) {
	return String(raw !== null && raw !== void 0 ? raw : "").trim().length === 0;
}
/**
...
function isBlockedNumber(value, cfg, country) {
	var _cfg$allow$exact$map, _cfg$allow, _cfg$exact$map, _cfg$exact, _cfg$prefixes, _cfg$countries, _cfg$lengths, _cfg$lengths2;
	const e164 = normaliseE164(value);
	if (!e164) return false;
	if (((_cfg$allow$exact$map = (_cfg$allow = cfg.allow) === null || _cfg$allow === void 0 || (_cfg$allow = _cfg$allow.exact) === null || _cfg$allow === void 0 ? void 0 : _cfg$allow.map((entry) => {
		var _normaliseE;
		return (_normaliseE = normaliseE164(entry)) !== null && _normaliseE !== void 0 ? _normaliseE : "";
	})) !== null && _cfg$allow$exact$map !== void 0 ? _cfg$allow$exact$map : []).includes(e164)) return false;
	if (((_cfg$exact$map = (_cfg$exact = cfg.exact) === null || _cfg$exact === void 0 ? void 0 : _cfg$exact.map((entry) => {
		var _normaliseE2;
		return (_normaliseE2 = normaliseE164(entry)) !== null && _normaliseE2 !== void 0 ? _normaliseE2 : "";
	})) !== null && _cfg$exact$map !== void 0 ? _cfg$exact$map : []).includes(e164)) return true;
	if ((_cfg$prefixes = cfg.prefixes) === null || _cfg$prefixes === void 0 ? void 0 : _cfg$prefixes.some((prefix) => e164.startsWith(prefix))) return true;
	if (((_cfg$countries = cfg.countries) === null || _cfg$countries === void 0 ? void 0 : _cfg$countries.length) && country && cfg.countries.includes(country)) return true;
	...
	const min = (_cfg$lengths = cfg.lengths) === null || _cfg$lengths === void 0 ? void 0 : _cfg$lengths.min;
	const max = (_cfg$lengths2 = cfg.lengths) === null || _cfg$lengths2 === void 0 ? void 0 : _cfg$lengths2.max;
...
function safeParse(raw, country) {
	try {
		return (0, libphonenumber_js_max.parsePhoneNumberFromString)(raw, country);
	} catch (_unused2) {
		return;
	}
}
...
function resolvePhoneNumber(raw, config = {}) {
	var _config$fallbackCount;
	const value = String(raw !== null && raw !== void 0 ? raw : "");
	...
	if ((_config$fallbackCount = config.fallbackCountries) === null || _config$fallbackCount === void 0 ? void 0 : _config$fallbackCount.length) attempts.push(...config.fallbackCountries);
...
function validatePhone(raw, options = {}) {
	var _options$minLength, _options$maxLength, _options$allowExtensi, _phoneNumber$country, _options$allowedCount;
	const results = [];
	const blocklist = options.blocklist || DEFAULT_BLOCKLIST;
	const minLength = (_options$minLength = options.minLength) !== null && _options$minLength !== void 0 ? _options$minLength : DEFAULT_MIN_LENGTH;
	const maxLength = (_options$maxLength = options.maxLength) !== null && _options$maxLength !== void 0 ? _options$maxLength : DEFAULT_MAX_LENGTH;
	const allowExtensions = (_options$allowExtensi = options.allowExtensions) !== null && _options$allowExtensi !== void 0 ? _options$allowExtensi : false;
	...
	if (((_options$allowedCount = options.allowedCountries) === null || _options$allowedCount === void 0 ? void 0 : _options$allowedCount.length) && (!country || !options.allowedCountries.includes(country))) results.push({
		isValid: false,
...
//#endregion
Object.defineProperty(exports, 'DEFAULT_BLOCKLIST', {
  enumerable: true,
  get: function () {
    return DEFAULT_BLOCKLIST;
  }
});
Object.defineProperty(exports, 'DEFAULT_MAX_LENGTH', {
  enumerable: true,
  get: function () {
    return DEFAULT_MAX_LENGTH;
  }
});
Object.defineProperty(exports, 'DEFAULT_MIN_LENGTH', {
  enumerable: true,
  get: function () {
    return DEFAULT_MIN_LENGTH;
  }
});
Object.defineProperty(exports, 'DEFAULT_REGION_FALLBACKS', {
  enumerable: true,
  get: function () {
    return DEFAULT_REGION_FALLBACKS;
  }
});
Object.defineProperty(exports, 'PhoneChangeCodes', {
  enumerable: true,
  get: function () {
    return PhoneChangeCodes;
  }
});
Object.defineProperty(exports, 'PhoneValidationCodes', {
  enumerable: true,
  get: function () {
    return PhoneValidationCodes;
  }
});
Object.defineProperty(exports, 'SYMBOL_TRANSLITERATION_MAP', {
  enumerable: true,
  get: function () {
    return SYMBOL_TRANSLITERATION_MAP;
  }
});
Object.defineProperty(exports, 'isBlockedNumber', {
  enumerable: true,
  get: function () {
    return isBlockedNumber;
  }
});
...
Object.defineProperty(exports, 'looksLikePhone', {
  enumerable: true,
  get: function () {
    return looksLikePhone;
  }
});
Object.defineProperty(exports, 'resolvePhoneNumber', {
  enumerable: true,
  get: function () {
...
//# sourceMappingURL=validatePhone-DR-nxat8.cjs.map