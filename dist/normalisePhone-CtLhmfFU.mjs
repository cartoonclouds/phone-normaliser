import { d as PhoneChangeCodes, i as resolvePhoneNumber, n as isEmpty, p as SYMBOL_TRANSLITERATION_MAP, s as DEFAULT_BLOCKLIST, t as isBlockedNumber } from "./validatePhone-CiBuROp_.mjs";
...
function normalisePhone(raw, options = {}) {
	...
	if (usedFallback) changeCodes.push(PhoneChangeCodes.APPLIED_DEFAULT_COUNTRY);
	...
	if (options.allowedCountries?.length && (!country || !options.allowedCountries.includes(country))) {
	...
	if (format !== "E.164") changeCodes.push(PhoneChangeCodes.FORMATTED_OUTPUT);
	return buildResult({
...
//#endregion
export { normalisePhone as t };
//# sourceMappingURL=normalisePhone-CtLhmfFU.mjs.map